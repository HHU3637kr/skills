...
本项目构建了一套完整的 Skills 体系，旨在通过 **Obsidian** 实现 **Spec 驱动式开发**方法论。v2.0 版本引入 **Agent Teams 多角色协作架构**，将开发流程拆分为 5 个阶段，由 6 个专职角色分工协作，每个角色调用对应的 Skill 完成工作。整套体系融合了结构化文档管理、可追溯的开发流程和双层互补记忆系统，形成高效、可维护的开发工作流。
