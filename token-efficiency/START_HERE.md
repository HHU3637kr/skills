...
**token-efficiency v0.3.1** — 独立省 Token 插件（与任何其他产品无关）
...
```
我解压了 token-efficiency 插件，路径是：【改成你的解压路径，例如 /Users/xxx/Desktop/token-efficiency-0.3.1】
